...
- `frontend/app.js` bevat parsing van YAML-seeddata, localStorage-synchronisatie, categoriegroepering en interactie.
...
4. De gekozen categorievolgorde wordt in `localStorage` bewaard.
5. De UI toont boodschappen per gekozen supermarkt, gegroepeerd volgens de ingestelde categorievolgorde.
6. De service worker cachet de app-shell voor offline gebruik en forceert activatie van nieuwe versies.
